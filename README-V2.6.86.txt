SK Alumni System V2.6.92 – LINE Inbox Reliability + Conversation UX
...
VERSION
- API/UI/address query version synchronized to V2.6.92.

TEST
1. Deploy Worker.
2. In LINE send: แอดมิน ทดสอบข้อความ V2.6.92
