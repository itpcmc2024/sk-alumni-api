...
function loginUrl(){return 'admin.html?v=2.6.96'}
...
window.SK_ADMIN_SESSION={touch,clear:clearSession,getTimeout:()=>timeoutMin,getProfile:()=>{try{return JSON.parse(sessionStorage.getItem('sk_alumni_admin_profile')||'null')}catch{return null}},loadProfile};
