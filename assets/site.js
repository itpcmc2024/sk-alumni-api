const SK={API:'https://sk-alumni-api.itpcmc2024.workers.dev',VERSION:'V2.6.96'};
try{const u=new URL(location.href);if(u.searchParams.get('v')!=='2.6.96'){u.searchParams.set('v','2.6.96');history.replaceState(null,'',u.pathname+u.search+u.hash)}}catch{}
