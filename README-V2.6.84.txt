SK Alumni System V2.6.87 – Responsive + LINE Inbox Reliability + UX
...
3) Version Sync
   - Sync V2.6.87 ทั้ง UI/API/links
   - module-nav.js และ site.js จะปรับ query ?v=2.6.87 ใน address bar ให้ตรงกับเวอร์ชันปัจจุบันด้วย history.replaceState

ติดตั้ง
- นำไฟล์ทั้งหมดไปทับโฟลเดอร์ sk-alumni-api เดิม
- git add -A
- git commit -m "SK Alumni System V2.6.87 Responsive LINE Inbox UX"
