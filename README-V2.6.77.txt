SK Alumni System V2.6.79 – Admin Layout + Responsive + Performance Polish
...
- Sync runtime/query/footer/assets เป็น V2.6.79

Deploy:
git add -A
git commit -m "SK Alumni System V2.6.79 Admin Layout Responsive Performance Polish"
