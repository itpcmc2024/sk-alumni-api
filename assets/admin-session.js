...
function getKey(){for(const k of KEYS){const v=localStorage.getItem(k)||sessionStorage.getItem(k);if(v)return v}return''}
...
function loginUrl(){return 'admin.html?v=2.6.70'}
