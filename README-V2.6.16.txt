SK Alumni System V2.6.17 – Receipt Center + DB Compatibility + Admin Tabs
...
- Push GitHub Pages
- Worker จะสร้าง/เติมโครงสร้าง V2.6.17 แบบ additive อัตโนมัติ หรือจะรัน sql/migrate-v2.6.17-receipt-center.sql ใน PG Studio ก่อนก็ได้

ทดสอบแนะนำ
A. /api/health ต้องขึ้น version 2.6.17
