SK Alumni System V2.6.45 – Transaction Accounting Responsive Evidence + Summary Fix
...
- Mobile ledger form and toolbar responsive improvements.
- Amount is numeric-only; source gets full row; amount/reference share row; note full-width.
...
- Version/cache markers updated to V2.6.45.
