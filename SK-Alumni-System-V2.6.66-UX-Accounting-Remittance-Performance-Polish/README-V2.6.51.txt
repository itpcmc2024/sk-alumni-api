SK Alumni System V2.6.53 – Public Frame + Typography + Footer Polish
...
- Public footer standardized to Admin-style desktop row and compact mobile two-row layout.
- Footer module label automatically follows current page.
- Header/footer are injected by assets/module-nav.js for core public modules to avoid page CSS drift.
