(()=>{
  ...
  const header=()=>`<header class="sk-module-nav" data-sk-nav="v2.6.20"><div class="sk-nav-wrap">
    <a class="sk-nav-brand" href="index.html"><img class="sk-nav-logo" src="assets/association-logo.png?v=2.6.22" alt="โลโก้สมาคม"><div><div class="sk-nav-title" data-app-name><span class="sk-app-line">ระบบสมาชิกสมาคมศิษย์เก่า</span><span class="sk-app-line">นูรุ้ลอิสลามสัมพันธ์ (สุเหร่าเขียว)</span></div><div class="sk-nav-sub">🌙 Nurul Islam · SK Alumni Member System</div></div></a>
